...
# Repair previous generated thumbnail: it changed parent State, not the dialog StatefulBuilder.
...
p.write_text(s,encoding='utf-8')
print('photo delete uses dialog-local state and larger touch target')
