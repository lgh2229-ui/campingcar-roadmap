...
# Final CI compatibility pass. Avoid mutating unrelated working source.
...
# Do NOT globally rewrite callbacks: other photo controls can be outside StatefulBuilder scope.
...
p.write_text(s,encoding='utf-8')
print('final requested UI compatibility fixes applied without callback scope rewrite')
