...
# FINAL feature patch. Do not rewrite the working multi-photo picker.
...
if "Text('최종 등록일자:" not in s:
    # Insert at a stable detail-sheet anchor independent of address formatting.
    anchor="        Text(p.services.join(' · ')),"
    if anchor not in s: raise SystemExit('place detail services anchor missing')
...
# Preserve/verify multi-photo add + preview + X deletion.
