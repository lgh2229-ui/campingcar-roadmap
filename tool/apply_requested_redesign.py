    ...
    Widget serviceRow(String service, void Function(void Function()) setLocal) {
      ...
      return Padding(
        ...
        child: LayoutBuilder(builder: (context, box) {
          final compact = box.maxWidth < 390;
          final check = CheckboxListTile(contentPadding: EdgeInsets.zero, dense: true, controlAffinity: ListTileControlAffinity.leading, title: Text(_filterLabel(service), maxLines: 1, overflow: TextOverflow.ellipsis), value: selected, onChanged: (v) => setLocal(() {
