...
# Final guards: picker must not clear, must append, and X must delete by stable photo path.
...
# Keep vehicle-market behavior unchanged except old compatibility fixes.
...
p.write_text(s,encoding='utf-8')
print('validated place photo picker append + stable path X-delete')
