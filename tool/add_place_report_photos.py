...
# Notification UI temporarily disabled here; server-side notification generation remains enabled.
# Keep this photo/report patch focused so generated home_screen.dart stays syntactically stable.
